...
for pagina in range(2, 922):  # De 2 a 3 (para as páginas 2 e 3)
    url = f'https://www.suno.com.br/noticias/mercado/page/{pagina}/#ultimas-noticias'
...
#dados.to_csv('dados_mercado_suno.csv', index=False)
print(dados.head)
