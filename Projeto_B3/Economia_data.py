...
for pagina in range(2, 464):  # De 2 a 3 (para as páginas 2 e 3)
    url = f'https://www.suno.com.br/noticias/economia/page/{pagina}/#ultimas-noticias'
...
dados = pd.DataFrame({'Mercado': todas_noticias, 'Data': todas_datas})

# Exibindo o DataFrame
# Salvar os dados em um arquivo CSV
dados.to_csv('dados_economia_suno.csv', index=False)

# Mensagem indicando que a exportação foi realizada com sucesso
print('Dados exportados para dados_suno.csv')
#Posso colocar até 465